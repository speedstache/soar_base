...
class PermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permission" do
    assert_difference("Permission.count") do
      post permissions_url, params: { permission: { membership: @permission.membership, membership_user: @permission.membership_user } }
    end
  ...
  test "should update permission" do
    patch permission_url(@permission), params: { permission: { membership: @permission.membership, membership_user: @permission.membership_user } }
